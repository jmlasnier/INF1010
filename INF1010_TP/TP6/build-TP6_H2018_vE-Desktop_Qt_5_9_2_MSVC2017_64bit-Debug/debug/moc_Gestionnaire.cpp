...
#include "../../Code_TP6/Gestionnaire.h"
...
void Gestionnaire::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Gestionnaire::usagerAjoute)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Gestionnaire::*_t)(Usager * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Gestionnaire::usagerSupprime)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject Gestionnaire::staticMetaObject = {
